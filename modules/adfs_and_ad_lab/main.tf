...
module "azure_hub_with_bastion" {
  source = "github.com/jchancellor-ms/terraform//modules/azure_hub_with_bastion?ref=v0.0.13"
...
module "azure_spoke_with_custom_dns" {
  source = "github.com/jchancellor-ms/terraform//modules/azure_spoke_with_custom_dns?ref=v0.0.13"
...
module "azure_vnet_peering_hub_defaults" {
  source = "github.com/jchancellor-ms/terraform//modules/azure_vnet_peering_hub_defaults?ref=v0.0.13"
...
module "azure_vnet_peering_spoke_defaults" {
  source = "github.com/jchancellor-ms/terraform//modules/azure_vnet_peering_spoke_defaults?ref=v0.0.13"
...
module "azure_keyvault_with_access_policy" {
  source = "github.com/jchancellor-ms/terraform//modules/azure_keyvault_with_access_policy?ref=v0.0.13"
...
module "on_prem_dc" {
  source = "github.com/jchancellor-ms/terraform//modules/azure_guest_server_2016_dc?ref=v0.0.13"
...
module "adfs_vm" {
  source = "github.com/jchancellor-ms/terraform//modules/azure_guest_server_multiversion_plain_w_domain_join?ref=v0.0.13"
